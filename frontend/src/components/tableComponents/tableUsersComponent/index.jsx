              ...
              <TableRow key={row._id} sx={{ border: 0 }} hover>
                <TableCell>
                  <div id="buttons" style={{ display: "flex" }}>
                    ...
                    <button style={{ marginRight: "10px", cursor: "pointer", color: "red", border: "none", background: "none" }}><DeleteIcon style={{ cursor: 'pointer', fontSize: 17 }} onClick={(e) => openDeleteConfirm(e, row, row._id)} /></button>
                    <button style={{ marginRight: "10px", cursor: "pointer", color: "orange", border: "none", background: "none" }}><RemoveRedEyeIcon style={{ cursor: 'pointer', fontSize: 17 }} onClick={(e) => openView(e, row, row._id)} /></button>
                  </div>
                </TableCell>
